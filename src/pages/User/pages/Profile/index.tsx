...
import { getAvatarUrl, isAxiosUnprocessableEntityError, setProfileToLS } from 'src/utils'
...
export default function Profile() {
  ...
  const previewImage = React.useMemo(() => (file ? URL.createObjectURL(file) : ''), [file])
  ...
  const uploadAvatarMutation = useMutation(userApi.updateAvatar)
